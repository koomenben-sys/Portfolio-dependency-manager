...
export const Plus = ({ size }) => (
  <Icon d="M12 5v14m-7-7h14" size={size} />
);

export const Trash = ({ size }) => (
  <Icon d="M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2M10 11v6m4-6v6" size={size} />
);

export const Target = ({ size }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const Calendar = ({ size }) => (
  <Icon d="M3 4h18a2 2 0 012 2v14a2 2 0 01-2 2H3a2 2 0 01-2-2V6a2 2 0 012-2zm0 6h18M16 2v4M8 2v4" size={size} />
);

export const Users = ({ size }) => (
  <Icon d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 7a4 4 0 100 8 4 4 0 000-8zm14 14v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" size={size} />
);
